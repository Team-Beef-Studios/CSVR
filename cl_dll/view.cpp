...
void V_Init (void)
{
	...
	cl_bobcycle			= gEngfuncs.pfnRegisterVariable( "cl_bobcycle","0", 0 );
	cl_bob				= gEngfuncs.pfnRegisterVariable( "cl_bob","0", FCVAR_ARCHIVE );
	cl_bobup			= gEngfuncs.pfnRegisterVariable( "cl_bobup","0", 0 );
